...
def records_by_id(record_id: str,
                  instrument: str = None,
                  event: str = None,
                  token: str = None,
                  api_url: str = None,
    ...
    if api_url is None:
        api_url = os.environ.get(REDCAP_API_ENV_VAR,
                                 'https://redcap.tacc.utexas.edu/api/')
...
def record_by_id(record_id: str,
    ...
    return records_by_id(record_id, instrument, event, token, api_url,
                         transform)[0]
