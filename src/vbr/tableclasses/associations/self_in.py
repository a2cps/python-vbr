...
class DatasetInDataset(AssociationTable):
    ...
    parent_dataset = Column(Integer, ForeignKey('dataset.dataset_id'))
...
class FileInFile(AssociationTable):
    ...
    parent_file = Column(Integer, ForeignKey('file.file_id'))
...
class ProtocolInProtocol(AssociationTable):
    ...
    parent_protocol = Column(Integer, ForeignKey('protocol.protocol_id'))
