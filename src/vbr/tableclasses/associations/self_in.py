...
class DatasetInDataset(AssociationTable):
    ...
    parent_dataset = Column(
        Integer, ForeignKey("dataset.dataset_id", event_action="CASCADE")
    )
...
class ProtocolInProtocol(AssociationTable):
    ...
    protocol = Column(
        Integer, ForeignKey("protocol.protocol_id", event_action="CASCADE")
    )
    parent_protocol = Column(
        Integer, ForeignKey("protocol.protocol_id", event_action="CASCADE")
    )
