...
def _classes():
    ...
    for _, obj in inspect.getmembers(sys.modules[__name__]):
        if inspect.isclass(obj):
            if Table in obj.__bases__ or AssociationTable in obj.__bases__ or RcapTable in obj.__bases__ or VbrSysEventTable in obj.__bases__:
