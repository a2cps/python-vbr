"""Autogenerated 2021-09-02T13:30:49.008660 by redcap_classfiles.py
"""
...
class RcapAdverseChildhoodExperienceQuestionnaireAce(RcapTable):
    ...
    # This Survey will be asking you some questions about events th...
    # Field Type: descriptive
    # Choices: N/A
    dt_ace_preamble = Column(String, nullable=False, comments=None)
    # While you were growing up, during your first 18 years of life
    # Field Type: descriptive
    # Choices: N/A
    ace_dt_1 = Column(String, nullable=False, comments=None)
