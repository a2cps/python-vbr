"""Autogenerated 2021-10-12T11:00:08.367508 by redcap_classfiles.py
"""
...
class RcapTaps1(RcapTable):
    ...
    tapstobaccoproductscl = Column(Integer, nullable=False, comments=None)
    # How many years have you smoked?
    # Field Type: text
    # Choices: N/A
    tapstobaccoproductscl_yrs = Column(String, nullable=False, comments=None)
    # In the PAST 12 MONTHS, how often have you had 5 or more drink...
    # Field Type: radio
    # Choices: 0, Daily or Almost Daily | 1, Weekly | 2, Monthly | 3, Less Than Monthly | 4, Never
    tapsalcoholusemalescl = Column(Integer, nullable=False, comments=None)
    # In the PAST 12 MONTHS, how often have you had 4 or more drink...
    # Field Type: radio
    # Choices: 0, Daily or Almost Daily | 1, Weekly | 2, Monthly | 3, Less Than Monthly | 4, Never
    tapsalcoholusefemalescl = Column(Integer, nullable=False, comments=None)
    # In the PAST 12 MONTHS, how often have you used any drugs incl...
    # Field Type: radio
    # Choices: 0, Daily or Almost Daily | 1, Weekly | 2, Monthly | 3, Less Than Monthly | 4, Never
    tapsdrugusescl = Column(Integer, nullable=False, comments=None)
    # In the PAST 12 MONTHS, how often have you used any prescripti...
    # Field Type: radio
    # Choices: 0, Daily or Almost Daily | 1, Weekly | 2, Monthly | 3, Less Than Monthly | 4, Never
    tapsprescriptionmedusescl = Column(Integer, nullable=False, comments=None)
