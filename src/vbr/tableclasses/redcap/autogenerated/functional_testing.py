"""Autogenerated 2021-09-02T15:55:09.560842 by redcap_classfiles.py
"""
...
class RcapFunctionalTesting(RcapTable):
    ...
    walk10assist_cane = Column(Boolean, nullable=False, comments=None)
    # Field Name was empty in Data Dictionary
    # Field Type: checkbox
    # Choices: 1, Crutches (1 or 2, any gait pattern)
    walk10assist_crutch = Column(Boolean, nullable=False, comments=None)
    # Field Name was empty in Data Dictionary
    # Field Type: checkbox
    # Choices: 1, Walker (all types)
    walk10assist_walkder = Column(Boolean, nullable=False, comments=None)
    # Field Name was empty in Data Dictionary
    # Field Type: checkbox
    # Choices: 1, Personal assistance (any type of 'hands-on' assistance or support during task, even if only briefly or for balance)
    walk10assist_perssuppt = Column(Boolean, nullable=False, comments=None)
    # Field Name was empty in Data Dictionary
    # Field Type: checkbox
    # Choices: 1, Other
    walk10assist_other = Column(Boolean, nullable=False, comments=None)
    # Other, specify
    # Field Type: text
    # Choices: N/A
    ...
    tstsassist_1 = Column(Boolean, nullable=False, comments=None)
    # Field Name was empty in Data Dictionary
    # Field Type: checkbox
    # Choices: 1, personal assistance (any type of 'hands-on' assistance or support during task, even if only briefly or for balance)
    tstsassist_2 = Column(Boolean, nullable=False, comments=None)