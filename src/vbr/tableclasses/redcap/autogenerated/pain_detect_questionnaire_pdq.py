"""Autogenerated 2021-09-02T15:55:09.457875 by redcap_classfiles.py
"""
...
class RcapPainDetectQuestionnairePdq(RcapTable):
    ...
    pain_detect_questionnaire_pdq_complete = Column(Integer, ForeignKey('status.status_id'))
    # Assessment Date
    # Field Type: text
    # Choices: N/A
    pdqassessdate = Column(String, nullable=False, comments=None)
    ...
    pdburnsens = Column(Integer, nullable=False, comments=None)
    # b. Do you have a <span style="text-decoration: underline;">ti...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdtinglsens = Column(Integer, nullable=False, comments=None)
    # c. Is <span style="text-decoration: underline;">light touchin...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdlttouch = Column(Integer, nullable=False, comments=None)
    # d. Do you have <span style="text-decoration: underline;">sudd...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdsudpanatt = Column(Integer, nullable=False, comments=None)
    # e. Is <span style="text-decoration: underline;">cold or heat<...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdbathwtr = Column(Integer, nullable=False, comments=None)
    # f. Do you suffer from a sensation of <span style="text-decora...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdnumb = Column(Integer, nullable=False, comments=None)
    # g. Does <span style="text-decoration: underline;">slight pres...
    # Field Type: radio
    # Choices: 0, Never | 1, Hardly Noticed | 2, Slightly | 3, Moderately | 4, Strongly | 5, Very Strongly
    pdslightpress = Column(Integer, nullable=False, comments=None)
    ...
    pdqpaincourse = Column(Integer, nullable=False, comments=None)
    # Does your pain ever radiate to other regions of your body?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    pdradiateregions = Column(Boolean, nullable=False, comments=None)