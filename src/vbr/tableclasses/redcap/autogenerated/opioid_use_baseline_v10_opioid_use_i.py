"""Autogenerated 2021-09-02T13:30:49.016271 by redcap_classfiles.py
"""
...
class RcapOpioidUseBaselineV10OpioidUseI(RcapTable):
    ...
    # Choices: N/A
    opioidusebsln_dt_1 = Column(String, nullable=False, comments=None)
    ...
    opioidusebsln_meddosehydroc1 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    ...
    opioidusebsln_meddosecodeine1 = Column(Integer,
                                           nullable=False,
                                           comments=None)
    ...
    opioidusebsln_meddosehydrom1 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    ...
    opioidusebsln_meddosemorph1 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    ...
    opioidusebsln_meddosefenta1 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    ...
    # Field Type: descriptive
    # Choices: N/A
    opioidusebsln_dt_2 = Column(String, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 5mg / 325mg | 2, Tablets with acetaminophen - 7.5mg / 325mg | 3, Tablets with acetaminophen - 10mg / 325mg | 4, Liquid - 7.5mg/500mg per 15ml
    opioidusebsln_meddosehydroc2 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioidusebsln_meddosecodeine2 = Column(Integer,
                                           nullable=False,
                                           comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release - 2mg | 2, Tablets immediate release - 4mg | 3, Tablets immediate release - 8mg | 4, Tablets immediate release - 12mg | 5, Tablets immediate release - 16mg | 6, Tablets immediate release - 32mg | 7, Liquid - 5mg / 5ml
    opioidusebsln_meddosehydrom2 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    # 2 What is the dose of your Morphine (MS Contin, MS IR)?
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release | 2, - 15mg | 3, - 30mg | 4, ------------------------------------- | 5, Tablets extended release | 6, - 15mg | 7, - 30mg | 8, - 60mg | 9, - 100mg | 10, - 200mg | 11, ------------------------------- | 12, Liquid - 10mg / 5ml
    opioidusebsln_meddosemorph2 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 2 What is the dose of your Tapentadol (Nucynta)?
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release | 2, - 50mg | 3, - 75mg | 4, - 100mg | 5, -------------------------------------- | 6, Tablets extended release | 7, - 50mg | 8, - 100mg | 9, - 150mg | 10, - 200mg | 11, - 250mg
    opioidusebsln_meddosetapen2 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 2 What is the dose of your Methadone?
    # Field Type: dropdown
    # Choices: 1, Tablets - 5mg | 2, Tablets - 10mg | 3, Liquid - 10mg/ml
    opioidusebsln_meddosemetha2 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 2 What is the dose of your Fentanyl (Duragesic)?
    # Field Type: dropdown
    # Choices: 1, Patch - 12mcg | 2, Patch - 25mcg | 3, Patch - 50mcg | 4, Patch - 75mcg | 5, Patch - 100mcg
    opioidusebsln_meddosefenta2 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    ...
    # Field Type: descriptive
    # Choices: N/A
    opioidusebsln_dt_3 = Column(String, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 5mg / 325mg | 2, Tablets with acetaminophen - 7.5mg / 325mg | 3, Tablets with acetaminophen - 10mg / 325mg | 4, Liquid - 7.5mg/500mg per 15ml
    opioidusebsln_meddosehydroc3 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioidusebsln_meddosecodeine3 = Column(Integer,
                                           nullable=False,
                                           comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release - 2mg | 2, Tablets immediate release - 4mg | 3, Tablets immediate release - 8mg | 4, Tablets immediate release - 12mg | 5, Tablets immediate release - 16mg | 6, Tablets immediate release - 32mg | 7, Liquid - 5mg / 5ml
    opioidusebsln_meddosehydrom3 = Column(Integer,
                                          nullable=False,
                                          comments=None)
    # 3 What is the dose of your Morphine (MS Contin, MS IR)?
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release | 2, - 15mg | 3, - 30mg | 4, ------------------------------------- | 5, Tablets extended release | 6, - 15mg | 7, - 30mg | 8, - 60mg | 9, - 100mg | 10, - 200mg | 11, ------------------------------- | 12, Liquid - 10mg / 5ml
    opioidusebsln_meddosemorph3 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 3 What is the dose of your Tapentadol (Nucynta)?
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release | 2, - 50mg | 3, - 75mg | 4, - 100mg | 5, -------------------------------------- | 6, Tablets extended release | 7, - 50mg | 8, - 100mg | 9, - 150mg | 10, - 200mg | 11, - 250mg
    opioidusebsln_meddosetapen3 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 3 What is the dose of your Methadone?
    # Field Type: dropdown
    # Choices: 1, Tablets - 5mg | 2, Tablets - 10mg | 3, Liquid - 10mg/ml
    opioidusebsln_meddosemetha3 = Column(Integer,
                                         nullable=False,
                                         comments=None)
    # 3 What is the dose of your Fentanyl (Duragesic)?
    # Field Type: dropdown
    # Choices: 1, Patch - 12mcg | 2, Patch - 25mcg | 3, Patch - 50mcg | 4, Patch - 75mcg | 5, Patch - 100mcg
    opioidusebsln_meddosefenta3 = Column(Integer,
                                         nullable=False,
                                         comments=None)
