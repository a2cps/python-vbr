"""Autogenerated 2021-09-02T13:30:49.080590 by redcap_classfiles.py
"""
...
class RcapReportableEventdeviationV03(RcapTable):
    ...
    # Field Type: text
    # Choices: N/A
    erep_local_dtime = Column(String, nullable=False, comments=None)
    # Submitted by username
    # Field Type: text
    # Choices: N/A
    erep_submit_user = Column(String, nullable=False, comments=None)
    # Date of adverse event
    # Field Type: text
    # Choices: N/A
    erep_ae_date = Column(String, nullable=False, comments=None)
    # Staff/Investigator initials
    # Field Type: text
    # Choices: N/A
    erep_initials = Column(String, nullable=False, comments=None)
    ...
    erep_visit_inv = Column(Integer, nullable=False, comments=None)
    # Is this event
    # Field Type: descriptive
    # Choices: N/A
    erep_dt_1 = Column(String, nullable=False, comments=None)
    # Unanticipated Problem?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_unant_prob = Column(Boolean, nullable=False, comments=None)
    # Is this an adverse event?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_ae_yn = Column(Boolean, nullable=False, comments=None)
    # Date of Adverse event onset
    # Field Type: text
    # Choices: N/A
    erep_onset_date = Column(String, nullable=False, comments=None)
    # Date of Adverse Event resolution
    # Field Type: text
    # Choices: N/A
    erep_resolution_date = Column(String, nullable=False, comments=None)
    ...
    erep_ae_severity = Column(Integer, nullable=False, comments=None)
    ...
    erep_ae_relation = Column(Integer, nullable=False, comments=None)
    # Is the event serious?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_ae_serious = Column(Boolean, nullable=False, comments=None)
    # Other Event?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_oe = Column(Boolean, nullable=False, comments=None)
    # Date of event
    # Field Type: text
    # Choices: N/A
    erep_oe_date = Column(String, nullable=False, comments=None)
    # Protocol Deviation
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_prot_dev = Column(Boolean, nullable=False, comments=None)
    # Type of deviation
    # Field Type: radio
    ...
    erep_protdev_type = Column(Integer, nullable=False, comments=None)
    # Is this event related to COVID-19?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_rel_covid19 = Column(Boolean, nullable=False, comments=None)
    # Additional documentation available?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    erep_add_doc_yn = Column(Boolean, nullable=False, comments=None)
    # If yes, where?
    # Field Type: checkbox
    # Choices: 1, Electronic Medical Record | 2, Document uploaded to REDCap
    erep_whereavail = Column(Integer, nullable=False, comments=None)
    #      File # Description of uploaded file Uploaded file   1 {e...
    # Field Type: descriptive
    # Choices: N/A
    erep_dt_files = Column(String, nullable=False, comments=None)
    # Upload File #1: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_1 = Column(String, nullable=False, comments=None)
    # Upload File #2: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_2 = Column(String, nullable=False, comments=None)
    # Upload File #3: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_3 = Column(String, nullable=False, comments=None)
    # Upload File #4: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_4 = Column(String, nullable=False, comments=None)
    # Upload File #5: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_5 = Column(String, nullable=False, comments=None)
    # Upload File #6: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_6 = Column(String, nullable=False, comments=None)
    # Upload File #7: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_7 = Column(String, nullable=False, comments=None)
    # Upload File #8: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_8 = Column(String, nullable=False, comments=None)
    # Upload File #9: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_9 = Column(String, nullable=False, comments=None)
    # Upload File #10: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_10 = Column(String, nullable=False, comments=None)
    # Upload File #11: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_11 = Column(String, nullable=False, comments=None)
    # Upload File #12: Description
    # Field Type: text
    # Choices: N/A
    erep_file_descript_12 = Column(String, nullable=False, comments=None)
