"""Autogenerated 2024-09-18T10:32:28.923758 by redcap_classfiles.py
"""
...
class RcapImagingMcc2V01(RcapTable):
    ...
    # Optional: Patient Name as entered into scanner console if DIF...
    # Field Type: text
    # Choices: N/A
    ...
    fmri_magnet_name = Column(Integer, nullable=True, comments=None)
    # Ignored multiline Field Name in Data Dictionary
    # Field Type: radio
    ...
    # Field Type: yesno
    # Choices: N/A
    fmricuffspyn = Column(Boolean, nullable=True, comments=None)
    # 2nd Resting state
    # Field Type: yesno
    # Choices: N/A
    ...
    # Field Type: radio
    # Choices: 1, Yes | 0, No | 2, Mixed / not fully on - please describe in additional notes
