"""Autogenerated 2021-09-02T13:30:48.960966 by redcap_classfiles.py
"""
...
class RcapPostconsentStudyPlanCrfV06(RcapTable):
    ...
    # Note: Please leave this form status as "Unverified" until the...
    # Field Type: descriptive
    # Choices: N/A
    dt_sp_unverified = Column(String, nullable=False, comments=None)
    # Patient is Eligible
    # Field Type: descriptive
    # Choices: N/A
    dt_sp_eligible = Column(String, nullable=False, comments=None)
    # Patient is Ineligible
    # Field Type: descriptive
    # Choices: N/A
    dt_sp_eligible_2 = Column(String, nullable=False, comments=None)
    # Scheduling Visits
    # Field Type: descriptive
    # Choices: N/A
    sp_dt_1 = Column(String, nullable=False, comments=None)
    ...
    #    V1 (Pre-Op) time:   {sp_v1_preop_time} {sp_v1_preop_time_a...
    # Field Type: descriptive
    # Choices: N/A
    sp_dt_preop_datetime = Column(String, nullable=False, comments=None)
    # V1 (Pre-Op) time
    # Field Type: text
    # Choices: N/A
    ...
    # Alert!  This participant has been withdrawn from the study. T...
    # Field Type: descriptive
    # Choices: N/A
    sp_dt_wd_alert = Column(String, nullable=False, comments=None)
