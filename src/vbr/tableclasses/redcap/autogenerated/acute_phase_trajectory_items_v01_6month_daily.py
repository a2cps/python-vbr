"""Autogenerated 2021-10-12T11:27:30.977559 by redcap_classfiles.py
"""
...
class RcapAcutePhaseTrajectoryItemsV016MonthDaily(RcapTable):
    ...
    acute_phase_trajectory_items_v01_6month_daily_complete = Column(Integer, ForeignKey('status.status_id'))
    # Date entered
    # Field Type: text
    # Choices: N/A
