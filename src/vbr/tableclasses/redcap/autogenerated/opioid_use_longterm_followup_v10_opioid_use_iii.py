"""Autogenerated 2021-11-05T15:48:31.896479 by redcap_classfiles.py
"""
...
class RcapOpioidUseLongtermFollowupV10OpioidUseIii(RcapTable):
    ...
    opioid_use_longterm_followup_v10_opioid_use_iii_id = (
    ...
    opioiduselfu_meddosecodeine1 = Column(Integer, nullable=True, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduselfu_meddosecodeine2 = Column(Integer, nullable=True, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduselfu_meddosecodeine3 = Column(Integer, nullable=True, comments=None)
