"""Autogenerated 2021-09-02T13:30:49.032359 by redcap_classfiles.py
"""
...
class RcapRapidAssessmentOfPhysicalActivityV10Rapa(RcapTable):
    ...
    # Choices: N/A
    rapa_dt_1 = Column(String, nullable=False, comments=None)
    # I rarely or never do any physical activities. Does this accur...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_rarly = Column(Boolean, nullable=False, comments=None)
    # I do some light or moderate physical activities, but not ever...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_light = Column(Boolean, nullable=False, comments=None)
    # I do some light physical activity every week.  Does this accu...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_lightweekly = Column(Boolean, nullable=False, comments=None)
    # I do moderate physical activities every week, but less  than ...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_mod = Column(Boolean, nullable=False, comments=None)
    # I do vigorous physical activities every week, but less  than ...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_vig = Column(Boolean, nullable=False, comments=None)
    # I do 30 minutes or more a day of moderate physical  activitie...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_modweekly = Column(Boolean, nullable=False, comments=None)
    # I do 20 minutes or more a day of vigorous physical  activitie...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_vigweekly = Column(Boolean, nullable=False, comments=None)
    # I do activities to increase muscle strength, such as  lifting...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_strength = Column(Boolean, nullable=False, comments=None)
    # I do activities to improve flexibility, such as stretching  o...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    rapa_flex = Column(Boolean, nullable=False, comments=None)
