"""Autogenerated 2021-09-02T13:30:49.046912 by redcap_classfiles.py
"""
...
class RcapAcutePhaseTrajectoryItemsV05AcuteDaily(RcapTable):
    ...
    # Choices: N/A
    traj04_dt_2 = Column(String, nullable=False, comments=None)
    ...
    # Field Type: descriptive
    # Choices: N/A
    traj04wk_dt = Column(String, nullable=False, comments=None)
