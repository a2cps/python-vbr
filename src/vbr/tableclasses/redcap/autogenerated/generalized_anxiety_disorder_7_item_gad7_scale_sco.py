"""Autogenerated 2021-09-02T13:30:48.990903 by redcap_classfiles.py
"""
...
class RcapGeneralizedAnxietyDisorder7ItemGad7ScaleSco(RcapTable):
    ...
    gad2feelnervscl = Column(Integer, nullable=False, comments=None)
    # Not being able to stop or control worrying
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad2notstopwryscl = Column(Integer, nullable=False, comments=None)
    # Worrying too much about different things
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad7wrytoomchscl = Column(Integer, nullable=False, comments=None)
    # Trouble relaxing
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad7troubrelxscl = Column(Integer, nullable=False, comments=None)
    # Being so restless that it's hard to sit still
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad7rstlessscl = Column(Integer, nullable=False, comments=None)
    # Becoming easily annoyed or irritable
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad7easyannoyedscl = Column(Integer, nullable=False, comments=None)
    # Feeling afraid as if something awful might happen
    # Field Type: radio
    # Choices: 0, Not at all | 1, Several days | 2, Over half the days | 3, Nearly every day
    gad7feelafrdscl = Column(Integer, nullable=False, comments=None)
    ...
    gad7difficulttowork = Column(Integer, nullable=False, comments=None)
