"""Autogenerated 2021-09-02T13:30:49.034925 by redcap_classfiles.py
"""
...
class RcapGeneralSensorySensitivityV02Gss8(RcapTable):
    ...
    # Instructions: Please read the following list of symptoms. If ...
    # Field Type: descriptive
    # Choices: N/A
    gss8_dt_1 = Column(String, nullable=False, comments=None)
    # Sensitivity to bright lights
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8photophobia = Column(Boolean, nullable=False, comments=None)
    # Sensitivity to sounds
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8phonophobia = Column(Boolean, nullable=False, comments=None)
    # Sensitivity to odors (e.g., perfumes, detergents, gasoline)
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8odorsensitiv = Column(Boolean, nullable=False, comments=None)
    # Sensitivity to certain flavors (e.g., sour, sweet, bitter)
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8flavorsensitiv = Column(Boolean, nullable=False, comments=None)
    # Sensitivity to touch or physical contact (e.g., certain fabri...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8touchsensitiv = Column(Boolean, nullable=False, comments=None)
    # Problems with balance
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8balance = Column(Boolean, nullable=False, comments=None)
    # Problems with nausea
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8nausea = Column(Boolean, nullable=False, comments=None)
    # Problems with rapid heart rate
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    gss8rapidhr = Column(Boolean, nullable=False, comments=None)
