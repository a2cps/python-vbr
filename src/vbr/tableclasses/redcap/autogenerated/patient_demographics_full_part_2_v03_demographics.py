"""Autogenerated 2021-10-12T11:00:08.401833 by redcap_classfiles.py
"""
...
class RcapPatientDemographicsFullPart2V03Demographics(RcapTable):
    ...
    edulevel = Column(Integer, nullable=False, comments=None)
    ...
    empstat = Column(Integer, nullable=False, comments=None)
    ...
    maristat = Column(Integer, nullable=False, comments=None)
    ...
    incmlvl = Column(Integer, nullable=False, comments=None)
    # Have you ever applied for, or received, disability insurance ...
    # Field Type: radio
    # Choices: 0, No | 1, Yes
    disabinsind = Column(Boolean, nullable=False, comments=None)
    # How long have you had the type of pain for which you are enro...
    # Field Type: text
    # Choices: N/A
    paindur = Column(String, nullable=False, comments=None)
    ...
    dom_hand = Column(Integer, nullable=False, comments=None)
    # Was your surgery delayed due to COVID-19?
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    surg_delayed = Column(Boolean, nullable=False, comments=None)
    # Were you or anyone living in your household previously diagno...
    # Field Type: radio
    # Choices: 1, Yes | 0, No
    prev_covid19_dx = Column(Boolean, nullable=False, comments=None)
    # 15a. If yes, indicate who (check all that apply)
    # Field Type: checkbox
    # Choices: 1, myself | 2, a family member
    who_dx_in_hh = Column(Integer, nullable=False, comments=None)
    # How tall are you? (in ft and inches)
    # Field Type: text
    # Choices: N/A
    height_ft_part = Column(String, nullable=False, comments=None)
    #
    # Field Type: text
    # Choices: N/A
    height_inches_part = Column(String, nullable=False, comments=None)
    # How much do you weigh (in lbs)?
    # Field Type: text
    # Choices: N/A
    weight_lbs = Column(String, nullable=False, comments=None)
