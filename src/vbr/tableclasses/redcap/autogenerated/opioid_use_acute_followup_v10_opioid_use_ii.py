"""Autogenerated 2021-10-12T11:27:30.887458 by redcap_classfiles.py
"""
...
class RcapOpioidUseAcuteFollowupV10OpioidUseIi(RcapTable):
    ...
    opioiduseafu_meddosehydroc1 = Column(Integer, nullable=False, comments=None)
    ...
    opioiduseafu_meddosecodeine1 = Column(Integer, nullable=False, comments=None)
    ...
    opioiduseafu_meddosehydrom1 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 5mg / 325mg | 2, Tablets with acetaminophen - 7.5mg / 325mg | 3, Tablets with acetaminophen - 10mg / 325mg | 4, Liquid - 7.5mg/500mg per 15ml
    opioiduseafu_meddosehydroc2 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduseafu_meddosecodeine2 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release - 2mg | 2, Tablets immediate release - 4mg | 3, Tablets immediate release - 8mg | 4, Tablets immediate release - 12mg | 5, Tablets immediate release - 16mg | 6, Tablets immediate release - 32mg | 7, Liquid - 5mg / 5ml
    opioiduseafu_meddosehydrom2 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 5mg / 325mg | 2, Tablets with acetaminophen - 7.5mg / 325mg | 3, Tablets with acetaminophen - 10mg / 325mg | 4, Liquid - 7.5mg/500mg per 15ml
    opioiduseafu_meddosehydroc3 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduseafu_meddosecodeine3 = Column(Integer, nullable=False, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets immediate release - 2mg | 2, Tablets immediate release - 4mg | 3, Tablets immediate release - 8mg | 4, Tablets immediate release - 12mg | 5, Tablets immediate release - 16mg | 6, Tablets immediate release - 32mg | 7, Liquid - 5mg / 5ml
    opioiduseafu_meddosehydrom3 = Column(Integer, nullable=False, comments=None)
