"""Autogenerated 2021-10-12T11:54:28.865056 by redcap_classfiles.py
"""
...
class RcapOpioidUseAcuteFollowupV10OpioidUseIi(RcapTable):
    ...
    opioid_use_acute_followup_v10_opioid_use_ii_complete = Column(Integer, ForeignKey('status.status_id'))
    ...
    opioiduseafu_meddosecodeine1 = Column(Integer, nullable=True, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduseafu_meddosecodeine2 = Column(Integer, nullable=True, comments=None)
    ...
    # Field Type: dropdown
    # Choices: 1, Tablets with acetaminophen - 15mg / 300mg | 2, Tablets with acetaminophen - 30mg / 300mg | 3, Tablets with acetaminophen - 60mg / 300mg | 4, Liquid - 12mg / 120mg per 5ml | 5, Tylenol 3 | 6, Tylenol 4
    opioiduseafu_meddosecodeine3 = Column(Integer, nullable=True, comments=None)
