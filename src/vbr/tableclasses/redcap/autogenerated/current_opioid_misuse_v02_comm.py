"""Autogenerated 2021-09-02T13:30:49.030157 by redcap_classfiles.py
"""
...
class RcapCurrentOpioidMisuseV02Comm(RcapTable):
    ...
    # For the next questions, please answer as honestly as possible...
    # Field Type: descriptive
    # Choices: N/A
    comm_header1 = Column(String, nullable=False, comments=None)
