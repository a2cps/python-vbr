"""Autogenerated 2021-10-12T11:00:08.335826 by redcap_classfiles.py
"""
...
class RcapPromisSfV12PhysicalFunction8B(RcapTable):
    ...
    pfadochoresscl = Column(Integer, nullable=False, comments=None)
    # Are you able to go up and down stairs at a normal pace?
    # Field Type: radio
    # Choices: 5, Without any difficulty | 4, With a little difficulty | 3, With some difficulty | 2, With much difficulty | 1, Unable to do
    pfastairsscl = Column(Integer, nullable=False, comments=None)
    # Are you able to go for a walk of at least 15 minutes?
    # Field Type: radio
    # Choices: 5, Without any difficulty | 4, With a little difficulty | 3, With some difficulty | 2, With much difficulty | 1, Unable to do
    pfawalkscl = Column(Integer, nullable=False, comments=None)
    # Are you able to run errands and shop?
    # Field Type: radio
    # Choices: 5, Without any difficulty | 4, With a little difficulty | 3, With some difficulty | 2, With much difficulty | 1, Unable to do
    pfarunerrandsscl = Column(Integer, nullable=False, comments=None)
    ...
    pfaphyslaborlimitscl = Column(Integer, nullable=False, comments=None)
    # Does your health now limit you in doing moderate work around ...
    # Field Type: radio
    # Choices: 5, Not at all | 4, Very little | 3, Somewhat | 2, Quite a lot | 1, Cannot do
    pfamodwrklimitscl = Column(Integer, nullable=False, comments=None)
    # Does your health now limit you in lifting or carrying groceries?
    # Field Type: radio
    # Choices: 5, Not at all | 4, Very little | 3, Somewhat | 2, Quite a lot | 1, Cannot do
    pfagrocliftlimitscl = Column(Integer, nullable=False, comments=None)
    # Does your health now limit you in doing heavy work around the...
    # Field Type: radio
    # Choices: 5, Not at all | 4, Very little | 3, Somewhat | 2, Quite a lot | 1, Cannot do
    pfaheavyworklimitscl = Column(Integer, nullable=False, comments=None)
